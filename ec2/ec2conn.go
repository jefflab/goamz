...
func (ec2 *EC2Conn) query(params map[string]string, resp interface{}) error {
...
//
// See http://goo.gl/Mcm3b for more details.
func (ec2 *EC2Conn) RunInstances(options *RunInstances) (resp *RunInstancesResp, err error) {
...
//
// See http://goo.gl/3BKHj for more details.
func (ec2 *EC2Conn) TerminateInstances(instIds []string) (resp *TerminateInstancesResp, err error) {
...
func (ec2 *EC2Conn) Instances(instIds []string, filter *Filter) (resp *InstancesResp, err error) {
...
// Attach a volume.
func (ec2 *EC2Conn) AttachVolume(volumeId string, instanceId string, device string) (resp *AttachVolumeResp, err error) {
...
func (ec2 *EC2Conn) DeleteVolume(id string) (resp *SimpleResp, err error) {
...
func (ec2 *EC2Conn) DetachVolume(id string) (resp *SimpleResp, err error) {
...
func (ec2 *EC2Conn) Volumes(volIds []string, filter *Filter) (resp *VolumesResp, err error) {
...
//
// See http://goo.gl/cxU41 for more details.
func (ec2 *EC2Conn) CreateImage(options *CreateImage) (resp *CreateImageResp, err error) {
...
func (ec2 *EC2Conn) Images(ids []string, filter *Filter) (resp *ImagesResp, err error) {
...
//
// See http://goo.gl/bHO3zT for more details.
func (ec2 *EC2Conn) ImageAttribute(imageId, attribute string) (resp *ImageAttributeResp, err error) {
...
func (ec2 *EC2Conn) ModifyImageAttribute(imageId string, options *ModifyImageAttribute) (resp *SimpleResp, err error) {
...
func (ec2 *EC2Conn) RegisterImage(options *RegisterImage) (resp *RegisterImageResp, err error) {
...
//
// See http://docs.aws.amazon.com/AWSEC2/latest/APIReference/ApiReference-query-DeregisterImage.html
func (ec2 *EC2Conn) DeregisterImage(imageId string) (resp *DeregisterImageResp, err error) {
...
//
// See http://goo.gl/hQwPCK for more details.
func (ec2 *EC2Conn) CopyImage(options *CopyImage) (resp *CopyImageResp, err error) {
...
//
// See http://goo.gl/ttcda for more details.
func (ec2 *EC2Conn) CreateSnapshot(volumeId, description string) (resp *CreateSnapshotResp, err error) {
...
func (ec2 *EC2Conn) DeleteSnapshots(ids []string) (resp *SimpleResp, err error) {
...
func (ec2 *EC2Conn) Snapshots(ids []string, filter *Filter) (resp *SnapshotsResp, err error) {
...
func (ec2 *EC2Conn) CreateKeyPair(keyName string) (resp *CreateKeyPairResp, err error) {
...
func (ec2 *EC2Conn) DeleteKeyPair(name string) (resp *SimpleResp, err error) {
...
func (ec2 *EC2Conn) CreateSecurityGroup(group SecurityGroup) (resp *CreateSecurityGroupResp, err error) {
...
//
// See http://goo.gl/k12Uy for more details.
func (ec2 *EC2Conn) SecurityGroups(groups []SecurityGroup, filter *Filter) (resp *SecurityGroupsResp, err error) {
...
func (ec2 *EC2Conn) DeleteSecurityGroup(group SecurityGroup) (resp *SimpleResp, err error) {
...
func (ec2 *EC2Conn) AuthorizeSecurityGroup(group SecurityGroup, perms []IPPerm) (resp *SimpleResp, err error) {
...
func (ec2 *EC2Conn) RevokeSecurityGroup(group SecurityGroup, perms []IPPerm) (resp *SimpleResp, err error) {
	return ec2.authOrRevoke("RevokeSecurityGroupIngress", group, perms)
}

func (ec2 *EC2Conn) authOrRevoke(op string, group SecurityGroup, perms []IPPerm) (resp *SimpleResp, err error) {
...
func (ec2 *EC2Conn) CreateTags(resourceIds []string, tags []Tag) (resp *SimpleResp, err error) {
...
//
// See http://goo.gl/awKeF for more details.
func (ec2 *EC2Conn) StartInstances(ids ...string) (resp *StartInstanceResp, err error) {
...
//
// See http://goo.gl/436dJ for more details.
func (ec2 *EC2Conn) StopInstances(ids ...string) (resp *StopInstanceResp, err error) {
...
func (ec2 *EC2Conn) RebootInstances(ids ...string) (resp *SimpleResp, err error) {
